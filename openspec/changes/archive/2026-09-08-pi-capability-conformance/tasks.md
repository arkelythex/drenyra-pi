...
- [x] 1.2 Edit `README.md` `## Install` (around lines 60–64): state that npm publication is pending because the `ROADMAP.md` npm-release item remains unchecked; do not make `pi install npm:drenyra-pi` appear currently available. <!-- sdd-owner: implementation -->
